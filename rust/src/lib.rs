...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn empty_wpt(self: Pin<&mut SwervePathBuilderImpl>, idx: usize, x_guess: f64, y_guess: f64, heading_guess: f64);

        fn sgmt_initial_guess_points(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, guess_points: &Vec<InitialGuessPoint>);

        fn wpt_linear_velocity_direction(self: Pin<&mut SwervePathBuilderImpl>, idx: usize, angle: f64);
        fn wpt_linear_velocity_max_magnitude(self: Pin<&mut SwervePathBuilderImpl>, idx: usize, magnitude: f64);
        fn wpt_linear_velocity_polar(self: Pin<&mut SwervePathBuilderImpl>, idx: usize, magnitude: f64, angle: f64);
        ...
        fn sgmt_linear_velocity_direction(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, angle: f64);
        fn sgmt_linear_velocity_max_magnitude(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, magnitude: f64);
        fn sgmt_linear_velocity_polar(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, magnitude: f64, angle: f64);
        fn sgmt_angular_velocity(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, angular_velocity: f64);
        ...
        fn sgmt_heading(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, heading: f64);

        fn sgmt_circle_obstacle(self: Pin<&mut SwervePathBuilderImpl>, from_idx: usize, to_idx: usize, x: f64, y: f64, radius: f64);
...
impl SwervePathBuilder {
    ...
    pub fn empty_wpt(&mut self, idx: usize, x_guess: f64, y_guess: f64, heading_guess: f64) {
        crate::ffi::SwervePathBuilderImpl::empty_wpt(self.path.pin_mut(), idx, x_guess, y_guess, heading_guess);
    }

    pub fn sgmt_initial_guess_points(&mut self, from_idx: usize, guess_points: &Vec<crate::ffi::InitialGuessPoint>) {
        crate::ffi::SwervePathBuilderImpl::sgmt_initial_guess_points(self.path.pin_mut(), from_idx, guess_points);
    }

    pub fn wpt_linear_velocity_direction(&mut self, idx: usize, angle: f64) {
        crate::ffi::SwervePathBuilderImpl::wpt_linear_velocity_direction(self.path.pin_mut(), idx, angle);
    }

    pub fn wpt_linear_velocity_max_magnitude(&mut self, idx: usize, magnitude: f64) {
        crate::ffi::SwervePathBuilderImpl::wpt_linear_velocity_max_magnitude(self.path.pin_mut(), idx, magnitude);
    }

    pub fn wpt_linear_velocity_polar(&mut self, idx: usize, magnitude: f64, angle: f64) {
        crate::ffi::SwervePathBuilderImpl::wpt_linear_velocity_polar(self.path.pin_mut(), idx, magnitude, angle);
    }
    ...
    pub fn sgmt_linear_velocity_direction(&mut self, from_idx: usize, to_idx: usize, angle: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_linear_velocity_direction(self.path.pin_mut(), from_idx, to_idx, angle);
    }

    pub fn sgmt_linear_velocity_max_magnitude(&mut self, from_idx: usize, to_idx: usize, magnitude: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_linear_velocity_max_magnitude(self.path.pin_mut(), from_idx, to_idx, magnitude);
    }

    pub fn sgmt_linear_velocity_polar(&mut self, from_idx: usize, to_idx: usize, magnitude: f64, angle: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_linear_velocity_polar(self.path.pin_mut(), from_idx, to_idx, magnitude, angle);
    }

    pub fn sgmt_angular_velocity(&mut self, from_idx: usize, to_idx: usize, angular_velocity: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_angular_velocity(self.path.pin_mut(), from_idx, to_idx, angular_velocity);
    }
    ...
    pub fn sgmt_heading(&mut self, from_idx: usize, to_idx: usize, heading: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_heading(self.path.pin_mut(), from_idx, to_idx, heading);
    }

    pub fn sgmt_circle_obstacle(&mut self, from_idx: usize, to_idx: usize, x: f64, y: f64, radius: f64) {
        crate::ffi::SwervePathBuilderImpl::sgmt_circle_obstacle(self.path.pin_mut(), from_idx, to_idx, x, y, radius);
    }
