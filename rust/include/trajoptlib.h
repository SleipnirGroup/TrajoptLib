...
class SwervePathBuilderImpl {
 public:
  ...
  void empty_wpt(size_t idx, double x_guess, double y_guess, double heading_guess);

  void sgmt_initial_guess_points(size_t from_idx, const rust::Vec<InitialGuessPoint>& guess_points);
  ...
  void sgmt_linear_velocity_direction(size_t from_idx, size_t to_idx, double angle);
  void sgmt_linear_velocity_max_magnitude(size_t from_idx, size_t to_idx, double magnitude);
  void sgmt_linear_velocity_polar(size_t from_idx, size_t to_idx, double magnitude, double angle);
  void sgmt_angular_velocity(size_t from_idx, size_t to_idx, double angular_velocity);
  ...
  void sgmt_circle_obstacle(size_t from_idx, size_t to_idx, double x, double y, double radius);
