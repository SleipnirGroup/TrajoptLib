...
public:
     ...
     */
    bool operator==(const IntervalSet1d& other) const noexcept; // TODO: this might be =default?
    ...
    std::optional<SolutionError> CheckScalar(double scalar, const SolutionTolerances& tolerances) const noexcept;
